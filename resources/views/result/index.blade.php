...
<div>
    ...
    <div class="container">
        ...
        <div class="col-12 d-flex mb-4">
            <div class="col-6 p-0 border m-1">
            ...
            <div class="col-6 border p-0 m-1">
        ...
        <div class="col-12 d-flex m-1">
            <div class="col-6 border p-0">
                <div class="listening-result col-12 p-0">
                    <?php $wordCount = str_word_count($studentAnswer['writing']); ?>
                    <h6 class="p-2">III. Writing - <span>{{$wordCount}} word{{ $wordCount > 1 ? 's' : '' }}</span> </h6>
                    <span class="col-12 d-flex flex-column px-2 pb-2">{{$studentAnswer['writing']}}</span>
                </div>
            </div>
        </div>
    </div>
