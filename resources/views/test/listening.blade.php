<div class="col-12 p-0 mt-3">
    ...
    <div class='section-1 mt-3'>
        <table class="w-100 mb-4 mt-2">
            ...
            <tbody>
                ...
                <tr>
                    <td class="pl-2"><span><input type="input" class="form__field" placeholder="1" name="listen-1" />
                            called. Phone </span></td>
                    <td class="pl-2"><span><input type="input" class="form__field" placeholder="3" name="listen-3" />
                            called. </span> </span></td>
                </tr>
                <tr>
                    <td class="pl-2"><span>number: <input type="input" class="form__field" placeholder="2"
                                name="listen-2" /> </span></td>
                    <td class="pl-2"><span>Phone number: <input type="input" class="form__field" placeholder="4"
                                name="listen-4" /> </span></td>
                </tr>
            </tbody>
        </table>
    </div>
    ...
    <div class='section-3'>
        ...
        <div class="col-12 d-flex align-items-center p-0">
            <div class="col-6 p-0"><b>10.</b>Julia<input type="input" class="form__field" name="listen-10" /></div>
            <div class="col-6 p-0"><b>a.</b> sore throat</div>
        </div>
        <div class="col-12 d-flex align-items-center p-0">
            <div class="col-6 p-0"><b>11.</b>Henry<input type="input" class="form__field" name="listen-11" /></div>
            <div class="col-6 p-0"><b>b.</b> stomachache</div>
        </div>
        <div class="col-12 d-flex align-items-center p-0">
            <div class="col-6 p-0"><b>12.</b>Regina<input type="input" class="form__field" name="listen-12" /></div>
            <div class="col-6 p-0"><b>c.</b> cold</div>
        </div>
        <div class="col-12 d-flex align-items-center p-0">
            <div class="col-6 p-0"><b>13.</b>Dale<input type="input" class="form__field" name="listen-13" /></div>
            <div class="col-6 p-0"><b>d.</b> toothache</div>
        </div>
        <div class="col-12 d-flex align-items-center p-0">
            <div class="col-6 p-0"><b>14.</b>Victoria<input type="input" class="form__field" name="listen-14" /></div>
    ...
    <div class='section-4 mt-3'>
        ...
        <div class="border border-dark p-2">
            ...
            <div class="col-12 p-0"><span>Preferred location: wants to be closed to <input type="input"
                        class="form__field" placeholder="17" name="listen-17" /> Price: maximum £<input type="input"
                        class="form__field" placeholder="18" name="listen-18" /> per </span></div>
            ...
            <div class="col-12 p-0"><span>I suggest Flat 3 at <input type="input" class="form__field" placeholder="19"
                        name="listen-19" /> Road in Bampton.</span></div>
            <div class="col-12 p-0"><span>I will send further details to customer by <input type="input"
                        class="form__field" placeholder="20" name="listen-20" /></span></div>
        </div>
    </div>
</div>